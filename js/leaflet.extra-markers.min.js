...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["exports"], t)
    : t(((e.leaflet = e.leaflet || {}), (e.leaflet["extra-markers"] = {})));
})(this, function (e) {
  "use strict";
  var t = (L.ExtraMarkers = {});
  (t.version = L.ExtraMarkers.version = "1.2.1"),
    (t.Icon = L.ExtraMarkers.Icon =
      L.Icon.extend({
        options: {
          iconSize: [35, 45],
          iconAnchor: [17, 42],
        ...
        _createInner: function () {
          ...
          return (
            ...
            r.svg &&
              (a += this._createSvg(r.shape, this._getColorHex(r.markerColor))),
        ...
        _setIconStyles: function (e, t) {
          ...
          (a =
            "shadow" === t
              ? ((o = L.point(r.shadowAnchor || r.iconAnchor)), "shadow")
              : ((o = L.point(r.iconAnchor)), "icon")),
